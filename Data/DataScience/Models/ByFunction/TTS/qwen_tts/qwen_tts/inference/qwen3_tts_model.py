...
class Qwen3TTSModel:
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        config = Qwen3TTSConfig.from_pretrained(pretrained_model_name_or_path)
        ...
        speech_tokenizer_path = os.path.join(pretrained_model_name_or_path, "speech_tokenizer")
        ...
        generate_config_path = os.path.join(pretrained_model_name_or_path, "generation_config.json")
        ...
        processor = Qwen3TTSProcessor.from_pretrained(pretrained_model_name_or_path)
