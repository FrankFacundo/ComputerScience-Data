...
from ...torch_utils import SimpleConfig, layer_type_validation, logging, rope_config_validation

logger = logging.get_logger(__name__)


class Qwen3TTSSpeakerEncoderConfig(SimpleConfig):
    r"""
...
class Qwen3TTSTalkerCodePredictorConfig(SimpleConfig):
    r"""
...
class Qwen3TTSTalkerConfig(SimpleConfig):
    r"""
...
class Qwen3TTSConfig(SimpleConfig):
    """
