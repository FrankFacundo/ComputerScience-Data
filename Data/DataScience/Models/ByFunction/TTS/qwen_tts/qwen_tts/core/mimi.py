...
class MimiConfig(SimpleConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._frame_rate = frame_rate if frame_rate is not None else kwargs.get("_frame_rate")
        if num_semantic_quantizers >= self.num_quantizers:
            raise ValueError("num_semantic_quantizers must be lower than num_quantizers")
    ...
    def frame_rate(self) -> float:
        ...
        return self.encodec_frame_rate
