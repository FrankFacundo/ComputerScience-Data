...
from ..local_models import qwen_model_path, resolve_local_model_path
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description=(
            ...
            "Examples:\n"
            f"  qwen-tts-demo {qwen_model_path('Qwen3-TTS-12Hz-1.7B-CustomVoice')}\n"
            f"  qwen-tts-demo {qwen_model_path('Qwen3-TTS-12Hz-1.7B-VoiceDesign')} --port 8000 --ip 127.0.0.01\n"
            f"  qwen-tts-demo {qwen_model_path('Qwen3-TTS-12Hz-1.7B-Base')} --device cuda:0\n"
            f"  qwen-tts-demo {qwen_model_path('Qwen3-TTS-12Hz-1.7B-CustomVoice')} --dtype bfloat16 --no-flash-attn\n"
        ),
...
def _resolve_checkpoint(args: argparse.Namespace) -> str:
    ...
    return resolve_local_model_path(ckpt)
