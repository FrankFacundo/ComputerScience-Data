...
\begin{multicols*}{3}
    ...
    \textbf{Variable aléatoire réelle} : application mesurable $X:(\Omega,\mathcal{A})\to(\mathbb{R},\mathcal{B}(\mathbb{R}))$ telle que
    \[
        \{X\in B\} := X^{-1}(B)\in\mathcal{A},\quad \forall B\in\mathcal{B}(\mathbb{R}).
    \]
